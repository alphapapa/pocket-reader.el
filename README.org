...
If you use =w3m=, you might find this function useful to bind in =w3m-lnum-mode-map=:

#+BEGIN_SRC elisp
  (cl-defun ap/w3m-lnum-add-to-pocket (&key (type 1))
    "Add link to Pocket with lnum."
    (interactive)
    (w3m-with-lnum
     type ""
